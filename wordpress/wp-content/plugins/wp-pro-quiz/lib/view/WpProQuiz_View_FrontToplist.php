    ...
    public function show()
    {
        ...
        <div style="margin-bottom: 30px; margin-top: 10px;" class="wpProQuiz_toplist"
            ...
            <table class="wpProQuiz_toplistTable">
                <caption><?php printf(__('Tối đa %s điểm', 'wp-pro-quiz'), $this->points); ?></caption>
                <thead>
                <tr>
                    <th style="width: 40px;"><?php _e('Hạng', 'wp-pro-quiz'); ?></th>
                    <th style="text-align: left !important;"><?php _e('Tên', 'wp-pro-quiz'); ?></th>
                    <th style="width: 140px;"><?php _e('Thời gian thi', 'wp-pro-quiz'); ?></th>
                    <th style="width: 60px;"><?php _e('Điểm', 'wp-pro-quiz'); ?></th>
                    <th style="width: 75px;"><?php _e('Kết quả', 'wp-pro-quiz'); ?></th>
                </tr>
                </thead>
                <tbody>
                <tr>
